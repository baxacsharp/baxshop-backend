...
import { orderConfirmationEmail } from "../../helpers/email.js"
import { calculateTaxAmount } from "../../helpers/tax.js"
...
router.delete("/cancel/:orderId", JWTAuthMiddleware, async (req, res) => {
  try {
    const orderId = req.params.orderId
...
router.put("/status/item/:itemId", JWTAuthMiddleware, async (req, res) => {
  try {
